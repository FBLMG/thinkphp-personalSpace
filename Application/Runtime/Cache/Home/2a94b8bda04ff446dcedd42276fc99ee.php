        ...
        <div class="container">
            <div class="row">
                <div class="main-slider">
                 ...
                 <?php if($status == 0): ?><img src="/person/Public/home/images/home/slider/hill.png" class="slider-hill" alt="slider image">
                    <img src="/person/Public/home/images/home/slider/house.png" class="slider-house" alt="slider image">
                    <img src="/person/Public/home/images/home/slider/sun.png" class="slider-sun" alt="slider image">
                 <?php else: ?>
                    <img src="/person/Public/home/images/home/slider/hill2.png" class="slider-hill" alt="slider image">
                    <img src="/person/Public/home/images/home/slider/house2.png" class="slider-house" alt="slider image">
                    <img src="/person/Public/home/images/home/slider/month.png" class="slider-sun" alt="slider image"><?php endif; ?>
                    
                    <img src="/person/Public/home/images/home/slider/birds1.png" class="slider-birds1" alt="slider image">
                    <img src="/person/Public/home/images/home/slider/birds2.png" class="slider-birds2" alt="slider image">
                </div>
            </div>
        </div>
                             ...
                             <div class="team-single-wrapper">
                               <div class="team-single">
                                 <div class="person-thumb">
                                   <img src="/person/Public/img/uploads/lunbo/<?php echo ($vo["img"]); ?>" class="img-responsive" alt="" style="width: 262px;height: 262px;">
                                 </div>
                        ...
                        <div class="item">
                         <?php if(is_array($lunbo)): foreach($lunbo as $key=>$vo): if(($key > 3) AND ($key < 9)): ?><div class="col-sm-3 col-xs-6">
                               <div class="team-single-wrapper">
                                <div class="team-single">
                                   <div class="person-thumb">
                                      <img src="/person/Public/img/uploads/lunbo/<?php echo ($vo["img"]); ?>" class="img-responsive" alt="" style="width: 262px;height: 270px;">
                                   </div>
                                   <div class="social-profile">
                                     <ul class="nav nav-pills">
                                        <li><a href="#">I</a></li>
        ...
        <div class="container">
            ...
            <?php if(is_array($article)): $key = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key; if($key == 1): ?><div class="single-features">
                    <div class="col-sm-5 wow fadeInLeft" data-wow-duration="500ms" data-wow-delay="300ms">
                        <img src="/person/Public/img/uploads/fileimg/<?php echo ($vo["img"]); ?>" class="img-responsive" alt="" style="width: 400px;height: 184px;">
                    </div>
              ...
              <?php elseif($key == 2): ?>
                <div class="single-features">
                    ...
                    <div class="col-sm-5 wow fadeInRight" data-wow-duration="500ms" data-wow-delay="300ms">
                        <img src="/person/Public/img/uploads/fileimg/<?php echo ($vo["img"]); ?>" class="img-responsive" alt="" style="width: 427px;height: 140px;">
                    </div>
                </div>
              <?php elseif($key == 3): ?>
                <div class="single-features">
                    <div class="col-sm-5 wow fadeInLeft" data-wow-duration="500ms" data-wow-delay="300ms">
                        <img src="/person/Public/img/uploads/fileimg/<?php echo ($vo["img"]); ?>" class="img-responsive" alt="" style="width: 385x;height: 130px;">
                    </div>
                    <div class="col-sm-6 wow fadeInRight" data-wow-duration="500ms" data-wow-delay="300ms">
                        <h2><?php echo ($vo["filename"]); ?></h2>
                        <P><?php echo ($vo["describe"]); ?>.</P>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="clients text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                        <p><img src="/person/Public/home/images/home/clients.png" class="img-responsive" alt=""></p>
                    ...
                    <?php if(is_array($imgdata)): $key = 0; $__LIST__ = $imgdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key; if($key < 7): ?><div class="col-xs-3 col-sm-2">
                            <a href="<?php echo U('Image/lst','','');?>/id/<?php echo ($vo["tid"]); ?>"><img src="/person/Public/img/uploads/imgs/<?php echo ($vo["img"]); ?>" class="img-responsive" alt="" style="width: 98px;height: 130px;"></a>
                        </div><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                </div>
            </div>
