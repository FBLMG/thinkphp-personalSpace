    ...
    <section id="portfolio">
        <div class="container">
            <div class="row">
             ...
             <?php if(is_array($imgdata)): $i = 0; $__LIST__ = $imgdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!--  竖屏 -->
                <?php if($vo["imgwidth"] == '1' ): ?><div class="col-xs-6 col-sm-4 col-md-3 portfolio-item branded logos">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-single">
                                <div class="portfolio-thumb">
                                    <img src="/Public/img/uploads/imgs/<?php echo ($vo["img"]); ?>" class="img-responsive" alt="" style="width:210px;height:280px;margin-left: 25px;">
                                </div>
                                <div class="portfolio-view" style="width:210px;height:280px;margin-left: 25px;filter:alpha(opacity=50);opacity:0.5;background:none;">
                                    <ul class="nav nav-pills" style="color:#a4c2f4;font-size: 20px;">
                ...
                <!-- 横屏 -->
                      <div class="col-xs-6 col-sm-4 col-md-3 portfolio-item branded logos">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-single">
                                <div class="portfolio-thumb">
                                    <img src="/Public/img/uploads/imgs/<?php echo ($vo["img"]); ?>" class="img-responsive" alt="" style="width:280px;height:210px;margin-left: 25px;">
                                </div>
                                <div class="portfolio-view" style="width:280px;height:210px;margin-left: 25px;filter:alpha(opacity=50);opacity:0.5;background: ;margin-left: 25px;">
                                    <ul class="nav nav-pills" style="color:#a4c2f4;font-size: 20px;">
                                   <?php echo ($vo["describe"]); ?>
                                    </ul>
                                </div>
                    ...
                    <!-- 正方 -->
                      <div class="col-xs-6 col-sm-4 col-md-3 portfolio-item branded logos">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-single">
                                <div class="portfolio-thumb">
                                    <img src="/Public/img/uploads/imgs/<?php echo ($vo["img"]); ?>" class="img-responsive" alt="" style="width:210px;height:210px;margin-left: 25px;">
                                </div>
                                <div class="portfolio-view" style="width:210px;height:210px;margin-left: 25px;filter:alpha(opacity=50);opacity:0.5;background: ;margin-left: 25px;">
                                    <ul class="nav nav-pills" style="color:#a4c2f4;font-size: 20px;">
                                   <?php echo ($vo["describe"]); ?>
                                    </ul>
                                </div>
...
<!--弹框样式-->
    <script>
        $(function(){
          $('.portfolio-view').css('background','none')
        })
    </script>
    <script type="text/javascript">
    function pomessage(){
