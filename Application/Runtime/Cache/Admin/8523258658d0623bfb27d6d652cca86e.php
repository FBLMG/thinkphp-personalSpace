                      ...
                      <section class="panel">
                          <header class="panel-heading">
                              ...
                              <div class="panel-body">
                                  <form class="form-inline" role="form" action="http://www.dinghongzx.cn/Admin/User/adminlists" method="POST">
                                      ...
                                      <button type="button" class="btn btn-info" onClick="window.location.href='<?php echo U('User/deleteAllOperation','','');?>'"><i class="icon-refresh"></i>普通用户</button>
                                  </form>
                              </div>
                              <!-- 查询记录 -->
                          </header>
