              ...
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                              ...
                              <div class="panel-body">
                                  <form class="form-inline" role="form" action="http://www.dinghongzx.cn/Admin/Setting/operation" method="POST">
                                      <div class="form-group">
                                          <input type="text" class="form-control form-date" placeholder="开始时间" id="query_start_time"  name='query_start_time' value="<?php echo ($query_start_time); ?>" style="width: 150px;" >
                                      </div>
                                      <div class="form-group">
                                          <input type="text" class="form-control form-date" placeholder="结束时间" id="query_end_time"  name='query_end_time' value="<?php echo ($query_end_time); ?>" style="width: 150px;" >
                                      </div>
                                      <button type="submit" class="btn btn-success">查询</button>
                                      <button type="button" class="btn btn-info" onClick="window.location.href='<?php echo U('Setting/deleteAllOperation');?>'">清空记录</button>
                                  </form>
                              </div>
                              <!-- 查询记录 -->
                          </header>
                    ...
                    <?php if(is_array($result)): $key = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr class="odd gradeX">
                              ...
                              <td class="hidden-phone"><?php echo ($vo["login_ip"]); ?></td>
                              <td class="hidden-phone"><?php echo ($vo["login_city"]); ?></td>
                              <td class="center hidden-phone"><?php echo ($vo["operation_url"]); ?></td>
                              <td class="center hidden-phone"><?php echo (date('Y-m-d H:i:s',$vo["create_at"])); ?></td>
                              <td class="hidden-phone">
                                   <span class="label label-danger" style="cursor:pointer;" onClick="window.location.href='<?php echo U('Setting/deleteOperation','','');?>/id/<?php echo ($vo["id"]); ?>'">删除</span>
                              </td>
...
<!-- 日期组件-->
<!-- lib -->
<link rel="stylesheet" type="text/css" href="/Public/zui/lib/datetimepicker/datetimepicker.min.css">
