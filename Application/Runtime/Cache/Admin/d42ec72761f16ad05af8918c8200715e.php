              ...
              <!--普通用户添加-->
                ...
                <?php if(is_array($date)): $i = 0; $__LIST__ = $date;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form role="form">
                    <div class="form-group">
                      <label for="exampleInputEmail1">图片
                      </label>
                      <!---->
                      <!--头像-->
                      <div class="ibox-content">
                        <div class="row">     
                        <?php if($vo["imgwidth"] == '1' ): ?><img src="/Public/img/uploads/imgs/<?php echo ($vo["img"]); ?>" alt="点击修改图片" style="width:180px;height:240px;margin-left:20px;cursor:pointer;" data-toggle="modal" data-target="#updateimgs">
                        <?php elseif($vo["imgwidth"] == '2' ): ?>
                          <img src="/Public/img/uploads/imgs/<?php echo ($vo["img"]); ?>" alt="点击修改图片" style="width:240px;height:180px;margin-left:20px;cursor:pointer;" data-toggle="modal" data-target="#updateimgs">
                        <?php else: ?>
                          <img src="/Public/img/uploads/imgs/<?php echo ($vo["img"]); ?>" alt="点击修改图片" style="width:180px;height:180px;margin-left:20px;cursor:pointer;" data-toggle="modal" data-target="#updateimgs"><?php endif; ?>
                        </div>
                      </div>
                      <!--头像-->
                      <!---->
                    ...
                    <button type="button" class="btn btn-warning" onClick="window.location.href='<?php echo U('Image/imgs','','');?>/id/<?php echo ($vo["aid"]); ?>'">返回
                    </button>
...
<!-- 修改图片 -->
<div class="modal fade" id="updateimgs" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
   ...
   <form role="form" action="<?php echo U('Image/updateimg',array('id'=>$imgid));?>" enctype="multipart/form-data" method="post">
