                  ...
                  <aside class="col-lg-9">
                      <section class="panel">
                          <div class="panel-body">
                             ...
                             <!--相册-->
                          <?php if(is_array($result)): foreach($result as $key=>$alubm): if($alubm["imgwidth"] == 1): ?><img src="/Public/img/uploads/alumb/<?php echo ($alubm["img"]); ?>" alt="<?php echo ($alubm["name"]); ?>" class="img-thumbnail" style="width:180px;height:240px;cursor:default;margin-left:10px;"  onClick="window.location.href='<?php echo U('Image/imgs','','');?>/id/<?php echo ($alubm["id"]); ?>'"> 
                            <?php elseif($alubm["imgwidth"] == 2): ?> 
                              <img src="/Public/img/uploads/alumb/<?php echo ($alubm["img"]); ?>" alt="<?php echo ($alubm["name"]); ?>" class="img-thumbnail" style="width:240px;height:180px;cursor:default;margin-left:10px;"  onClick="window.location.href='<?php echo U('Image/imgs','','');?>/id/<?php echo ($alubm["id"]); ?>'">
                            <?php else: ?>
                              <img src="/Public/img/uploads/alumb/<?php echo ($alubm["img"]); ?>" alt="<?php echo ($alubm["name"]); ?>" class="img-thumbnail" style="width:180px;height:180px;cursor:default;margin-left:10px;"  onClick="window.location.href='<?php echo U('Image/imgs','','');?>/id/<?php echo ($alubm["id"]); ?>'"><?php endif; endforeach; endif; ?>
                             <!--相册-->
                          </div>
                      </section>
                  </aside>
