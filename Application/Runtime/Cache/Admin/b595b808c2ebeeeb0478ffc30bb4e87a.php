...
<html lang="en">
  ...
  <!-- sidebar menu end-->
          ...
          <section class="wrapper">
            ...
            <?php if(is_array($admindata)): $i = 0; $__LIST__ = $admindata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$adminvo): $mod = ($i % 2 );++$i;?><div class="panel-body">
                            <a href="#" class="task-thumb">
                                  <img src="/person/Public/img/uploads/admin/<?php echo ($adminvo["img"]); ?>" alt="" style="width: 90;height: 83px;">
                            </a>
         ...
         <?php if(is_array($admingj)): $i = 0; $__LIST__ = $admingj;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="panel-body">
           ...
           <div class="album">
            <a href="<?php echo U('Admin/Image/imglist');?>">
             <img alt="" src="/person/Public/admin/img/sm-img-1.jpg">
            </a>
            <a href="<?php echo U('Admin/Image/imglist');?>">
             <img alt="" src="/person/Public/admin/img/sm-img-2.jpg">
            </a>
            <a href="<?php echo U('Admin/Image/imglist');?>">
             <img alt="" src="/person/Public/admin/img/sm-img-3.jpg">
            </a>
            <a href="<?php echo U('Admin/Image/imglist');?>">
             <img alt="" src="/person/Public/admin/img/sm-img-1.jpg">
            </a>
    ...
    <script src="/person/Public/admin/js/jquery-1.8.3.min.js"></script>
    ...
    <script src="/person/Public/admin/js/jquery.sparkline.js" type="text/javascript"></script>
    <script src="/person/Public/admin/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
    <script src="/person/Public/admin/js/owl.carousel.js" ></script>
    <script src="/person/Public/admin/js/jquery.customSelect.min.js" ></script>

    <!--common script for all pages-->
    <script src="/person/Public/admin/js/common-scripts.js"></script>

    <!--script for this page-->
    <script src="/person/Public/admin/js/sparkline-chart.js"></script>
    <script src="/person/Public/admin/js/easy-pie-chart.js"></script>
<!-- 实时获得留言情况 -->
<!-- 实时获得留言情况 -->
<!-- 密码修改 -->
