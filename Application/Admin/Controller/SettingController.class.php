  ...
  public function addlunbo(){
     ...
     //
      ...
      if(!$info) {  // 上传错误提示错误信息
        ...
        $imageAddress='./Public/img/uploads/lunbo/'.$info['img']['savename']; 
        $image = new \Think\Image();
        $image->open($imageAddress);
        $image->thumb(262, 262,\Think\Image::IMAGE_THUMB_SCALE)->save($imageAddress);
